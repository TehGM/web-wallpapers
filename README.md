...
Note: this project was fully generated by Claude Fable 5, as part of experiment. The idea was merely to have a generated black hole wallpaper (to use with Wallpaper Engine). However I ended up liking the result so much, so decided to share it, especially since it can be statically hosted.

I didn't touch any code in the project. Doing such cool looking things is out of my competences.
